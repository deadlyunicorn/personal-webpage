...
export default function DetailedInfo(props:dataTypesInterface){
  return( ///just to avoid the Warning: possibly null
      ...
      <div className="grid grid-cols-2 gap-4 font-extralight">
        <div className="border-l-8 border-t-4 border-black dark:border-violet-900 rounded-r-lg rounded-b-lg bg-white bg-opacity-50 dark:bg-sky-100 dark:bg-opacity-10 p-2 shadow-lg h-auto overflow-auto">
          <p>
        ...
        <div className="border-l-8 border-t-4 border-black dark:border-violet-900 rounded-r-lg rounded-b-lg bg-white bg-opacity-50 dark:bg-sky-100 dark:bg-opacity-10 p-2 shadow-lg h-auto overflow-auto flex flex-col justify-center items-center p-2">
          <p>
