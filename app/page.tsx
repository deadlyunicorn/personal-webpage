...
export default function Home() {
  return (
    <div className="h-screen bg-gradient-to-b from-blue-300 to-red-300 overflow-hidden flex flex-col justify-center items-center  max-h-screen ">
      <div className="  h-auto sm:mt-0  sm:max-w-xs lg:max-w-md max-w-xs mt-4 lg:h-auto  ">
        <div className="  h-full  flex flex-col justify-center items-center overflow-hidden max-h-[80vh] ">
          ...
          <div 
            className="border-white border-t border-l  text-center bg-red-100 bg-opacity-50 rounded-b-md shadow-lg ">
